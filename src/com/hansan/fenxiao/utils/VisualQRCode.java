...
import java.io.UnsupportedEncodingException;
 ...
 public class VisualQRCode
 {
	 private static int version(char level, int dataBitlength) {
		 ...
		 * @throws IOException
		 */
		public static void createQRCode(String content, String bgPath, OutputStream output, char Level, Color DF, Integer startX, Integer startY, Integer QRCodeWidth, Boolean isDeformation,
