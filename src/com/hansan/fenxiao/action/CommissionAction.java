...
public class CommissionAction extends BaseAction
{
  ...
  public void userCommissionSum(){
	   String startStr = this.request.getParameter("startDate");
	   String endStr = this.request.getParameter("endDate");	   
	   HttpSession session = this.request.getSession();
	   User loginUser = (User)session.getAttribute("loginUser");

	   //SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
       Double sum = this.commissionService.getSumByPeriod(loginUser.getId(), startStr, endStr);
