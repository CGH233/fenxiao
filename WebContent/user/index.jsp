	...
	<div class="sn-block meb-list">
		<ul class="sn-list-input">
			...
			<ul class="sn-list-input">
				...
				<li>
					<a href="promoteQRCode.jsp" class="block wbox" >
				...
				<li>
					<a href="performance.jsp" class="block wbox" >
						<label class="meb-list-ico" style="background:url('../images/ico-mylqb.png') no-repeat left center;background-size:1rem 1rem;">我的业绩</label>
						<div class="wbox-flex tr sn-txt-muted arrow">
						</div>
					</a>
				</li>
