...
<script>
    if (location.hash.indexOf('error') != -1) {
        ...
        if (ua.indexOf('micromessenger') != -1) {
            ...
            window.location.href = param != '' ? _AP.decode(param) : 'alipayApi?money='+<%=money%>;
        }
    }
  ...
  //      window.location.href=basepath+'user/index.jsp';  //在这里指定其返回的地址
 //   } );
    
    pushHistory();
    window.addEventListener("popstate", function(e) {
        //alert("好嗨哟，感觉到达了人生巅峰！");//根据自己的需求实现的功能
        window.location.href="index.jsp";  //在这里指定其返回的地址
    }, false);
